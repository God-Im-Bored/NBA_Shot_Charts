...
//   shot.attr("cx", court_xScale(0))
//     .attr("cy", court_yScale(0))
//     .attr("r", court_yScale(0.25) - court_yScale(0))
//     .style("fill", true)
//     .style("stroke", "red");
  ...
  Outterbox.attr("x", court_xScale(-8))
  ...
  Innerbox.attr("x", court_xScale(-6))
    .attr("y", court_yScale(-4))
  ...
  OuterLine.attr("x", court_xScale(-25))
    .attr("y", court_yScale(-4))
  ...
  appendArcPath(
    ...
    .attr(
      "transform",
      "translate(" + court_xScale(0) + ", " + court_yScale(43) + ")"
    );

  appendArcPath(
    CenterInner,
    court_xScale(2) - court_xScale(0),
    -90 * (Math.PI / 180),
    90 * (Math.PI / 180)
  )
    .attr("fill", "none")
